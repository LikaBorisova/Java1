...
public class HW4 {
    ...
    public static String playerName = "Jocker";
    public static char player = 'J';
    ...
    public static int mapSizeMin = 8;
    public static int mapSizeMax = 15;
    public static char[][] map;
    public static char emptyCell = '_';

    public static char coinCell = '$';
    public static int coinCount;
    public static int coinValueMin = 10;
    public static int coinValueMax = 100;
